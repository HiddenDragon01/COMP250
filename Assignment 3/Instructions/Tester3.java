...
public class Tester {
    ...
    public static void testQuery(int[] q, ArrayList<Datum> points,  KDTree tree) {
    	...
    	float brute_time = (brute_e_time-brute_s_time) / 1000000; // Convert from nanoseconds to milliseconds
        ...
        if (tree_np_sqdst == brute_np_sqdst) {
        	...
        	if (points.size() >= 50000) { 
	        	if (tree_time < brute_time/2) { // Tree method must be significantly faster than brute force
    ...
    public static void printTreeParameters(KDTree tree) {
        ...
        System.out.print("(For reference, the height of a balanced tree with "+ tree.size() + " leaves in general should be around ");
    ...
    public static void main(String args[]) throws Exception {
        ...
        System.out.println("PLEASE READ: \n"
        		...
        		+ "   KDNode.nearestPointInNode implimentation is sufficently fast). \n"
            ...
            case 1: // Test for 1D points
                ...
                switch(op) {
                    ...
                    case RANDOM:
                    	...
                    	System.out.println("Time required to construct tree: "+(e_time-s_time)+" milliseconds");
                    	if ((e_time-s_time) >= 600 && (e_time-s_time) < 1200) {
                ...
                switch(op) {
                    ...
                    case RANDOM:
                    	...
                    	if ((e_time-s_time) >= 600 && (e_time-s_time) < 1200) {
                    		...
                    		System.out.println("WARNING: Tree construction time is too slow (maximum tree construction time is only a few thousand milliseconds)\n");
                    	}
                    	System.out.println();
                        break;
